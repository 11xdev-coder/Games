...
block1 = create_block('red',500,200,100,10)
block2 = create_block('blue',200,200,100,10)
block3 = create_block('green',200,300,100,10)
block4 = create_block('orange',500,300,100,10)
block5 = create_block('cyan',200,400,100,10)
block6 = create_block('pink',500,400,100,10)
while True:
    paddlepos = canvas.coords(paddle)
